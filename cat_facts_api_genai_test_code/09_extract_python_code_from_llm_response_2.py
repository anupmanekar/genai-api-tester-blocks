# This is working code with catfact api and WITHOUT splitting json docs
...
llm_response = chain.invoke({"context": data_json, "baseurl": baseurl, "endpoint": endpoint_spec})
print(llm_response)
